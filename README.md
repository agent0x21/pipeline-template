...
To exclude a detected .NET project, use `<CICD>false</CICD>` instead. The setting is case-insensitive and works with the legacy MSBuild XML namespace as well as SDK-style project files.
